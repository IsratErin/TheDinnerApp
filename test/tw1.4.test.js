...
describe("TW1.4 Handle native events, fire custom events [test events with Vue](/tw1.4.html)[or React](/tw1.4-react.html)", function tw1_4() {
    ...
    testComponent({vue: SidebarView},
        ...
        function tw1_4_1(output, index){
            ...
            checkCB(buttons[0].__vnode?.props?.onClick, "onClick listener on - button");
            checkCB(buttons[1].__vnode?.props?.onClick, "onClick listener on + button");
       });
    ...
    testComponent({vue: SidebarView},
        ...
        function tw1_4_3(output, index){
            ...
            checkCB(links[0].__vnode?.props?.onClick, "onClick listener on dish links");
        });
    ...
    testComponent({vue: SidebarView},
        ...
        function tw1_4_5(output, index){
            ...
            checkCB(buttons[2].__vnode?.props?.onClick, "onClick listener for dish X buttons");
        });
